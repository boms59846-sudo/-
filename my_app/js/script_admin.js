...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.switchView = function (viewName) {
        ...
        const allViews = [viewDashboard, viewPersonnel, viewAssessment, viewAssessmentPeriod,
            viewAssessmentLine, viewOrganization, viewReportSummary, viewReportStatistics, viewAddPersonnel, viewProfile];
        ...
        const allNavs = [navDashboard, navPersonnel, navAssessment, navAssessmentPeriod,
            navAssessmentLine, navOrganization, navReportSummary, navReportStatistics, navCommittee];
